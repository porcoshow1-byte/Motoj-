        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative bg-gray-800 rounded-2xl p-4 md:p-8 border border-gray-700 shadow-2xl">
             ...
             <div className="text-center">
               <button onClick={onStartDemo} className="inline-flex items-center gap-2 text-orange-400 font-bold hover:text-orange-300 transition">
                 Acessar Painel Admin na Demo <ArrowRight size={16} />
               </button>
             </div>
          </div>
        </div>
